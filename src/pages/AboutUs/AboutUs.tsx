        ...
        <>
            ...
            <div className="team_member">
                <div className="card22">
                    <a href=""><img src="images/fahad.png" alt="" width="35%" /></a>
                    <div className="container">
                        <h4><b>Fahad kabir</b></h4>
                        <p>Conestoga College</p>
                       
                    </div>
                </div>
                <div className="card22">
                    <a href=" student-directory/1 "><img src="images/bhumil-modified.png" alt="" width="15%" /></a>
                    <div className="container">
                        <h4><b>Bhumil Patel</b></h4>
                        <p>Conestoga College</p>
                     
                    </div>
                </div>
                <div className="card22">
                    <a href="  "><img src="images/Richita-modified.png" alt="" width="35%" /></a>
                    <div className="container">
                        <h4><b>Richita Rodrigues</b></h4>
                        <p>Conestoga College</p>
