...
export const dummyUsers = [
    ...
    new User(2, "John", "Doe", 1234567809, "05-11-2000", "test1234@gmail.com", "password","https://icon-library.com/images/avatar-icon-images/avatar-icon-images-4.jpg", dummyCollege1, dummyLocation, dummyCampus1),
]
